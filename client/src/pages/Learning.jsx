...
function Learning() {
    ...
    const [checkingCompletion, setCheckingCompletion] = useState(Boolean(selectedBusiness));
    ...
    useEffect(() => {
        ...
        fetchMyEnrollments().then((list) => {
            const enrollment = list.find((e) => e.businessTitle === selectedBusiness);
            ...
            <MainLayout>
                <section className="listing-page">
                    ...
                    <div className="login-required-note">
                        <p>Please log in to view learning resources matched to your skills.</p>
        ...
        return (
            <MainLayout>
                <section className="listing-page">
                    <h1>Learning Resources</h1>
                    <div className="login-required-note">
                        <p>Complete your skill assessment first to see resources matched to you.</p>
